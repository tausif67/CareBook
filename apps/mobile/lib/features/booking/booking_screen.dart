...
class _BookingScreenState extends ConsumerState<BookingScreen> {
  ...
  @override void initState() { super.initState(); razorpay.on(Razorpay.EVENT_PAYMENT_SUCCESS, (_) => context.go('/appointments')); razorpay.on(Razorpay.EVENT_PAYMENT_ERROR, (response) => _message(response.message ?? 'Payment failed')); Future.microtask(loadDoctor); }
